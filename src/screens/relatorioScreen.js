          ...
          <View>
            ...
            {produtos.map((item) => (
              <TouchableOpacity key={item.id} onPress={() => setProdutoSelecionado(item)} style={{ backgroundColor: roxo }} className="p-8 rounded-[40px] items-center shadow-xl mb-4 flex-row justify-between">
                <Text style={{ fontSize: rf(14) }} className="text-white font-black uppercase text-center">{item.nome}</Text>
              ...
              <View>
                ...
                <View className="bg-white border border-gray-200 rounded-[35px] overflow-hidden mb-8 shadow-sm">
                  ...
                  <View className="p-5">
                    ...
                    <View className="flex-row justify-between mb-4 border-t border-gray-100 pt-2"><Text style={{ fontSize: rf(12) }} className="font-bold">Mark-up Calculado</Text><Text style={{ fontSize: rf(12) }} className="font-black text-purple-700">{r.markupIndice.toFixed(2)}x</Text></View>
